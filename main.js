...
module.exports = "<div class=\"container main-container\">\n    <h1>FireChat</h1>\n\n    <div class=\"col-md-12 text-right\" (click)=\"_cs.logout()\" *ngIf=\"_cs.usuarios.uid\">\n        <button type=\"button\" class=\"btn btn-outline-danger\">\n            Salir\n        </button>\n    </div>\n\n    <app-login *ngIf=\"!_cs.usuarios.uid\"></app-login>\n\n\n\n    <div class=\"chat-window\" *ngIf=\"_cs.usuarios.uid\">\n        <app-chat></app-chat>\n    </div>\n\n\n</div>"
...
module.exports = "<h1>Chat</h1>\n<hr>\n\n<div class=\"app-mensajes\" id=\"app-mensajes\">\n\n    <div *ngFor=\"let chat of _cs.chats\" [ngClass]=\"{'text-right':_cs.usuarios.uid == chat.uid}\">\n        <span class=\"badge\" [ngClass]=\"{'badge-primary':_cs.usuarios.uid == chat.uid, 'badge-success':_cs.usuarios.uid != chat.uid}\">{{chat.nombre}}</span>\n        <p>{{chat.mensaje}}</p>\n    </div>\n\n    <!--<div class=\"app-mensajes\" id=\"app-mensajes\">\n    <div class=\"text-right\">\n        <span class=\"badge badge-primary\">Andres</span>\n        <p>Este es un mensaje</p>\n    </div>\n    <div class=\"text-left\">\n        <span class=\"badge badge-success\">Maria Andrea</span>\n        <p>Hola guapo ;)</p>\n    </div>\n</div>>-->\n\n    <input class=\"form-control\" type=\"text\" name=\"mensaje\" [(ngModel)]=\"mensaje\" placeholder=\"Enviar mensaje\" (keyup.enter)=\"enviar_mensaje()\">"
    ...
    ChatComponent.prototype.enviar_mensaje = function () {
        ...
        if (this.mensaje.length === 0) {
            ...
            this._cs.agregarMensaje(this.mensaje)
                ...
                .catch(function (err) { return console.error('No se pudo enviar', err); });
        }
    };
...
module.exports = "<div class=\"row\">\n    <div class=\"col-md-12 text-center\">\n        <p>ingrese al chat con su cuenta</p>\n        <button type=\"button\" class=\"btn btn-outline-primary\" (click)=\"ingresar('google')\">Google</button>\n        <button type=\"button\" class=\"btn btn-outline-success\" (click)=\"ingresar('twitter')\">Twitter</button>\n    </div>\n</div>"
...
var ChatService = /** @class */ (function () {
    function ChatService(afs, afAuth) {
        ...
        this.afAuth.authState.subscribe(function (user) {
            ...
            _this.usuarios.nombre = user.displayName;
            _this.usuarios.uid = user.uid;
        });
    }
    ChatService.prototype.login = function (proveedor) {
        if (proveedor === 'google') {
            ...
            console.log('Autenticación por twitter no disponible');
        }
    };
...
var environment = {
    production: false,
    firebase: {
        apiKey: 'AIzaSyA8hHM10708WrVhtd3M0ZgzlMQhDFxEeIk',
        authDomain: 'firechat-7357a.firebaseapp.com',
        databaseURL: 'https://firechat-7357a.firebaseio.com',
        projectId: 'firechat-7357a',
        storageBucket: 'firechat-7357a.appspot.com',
        messagingSenderId: '43371574632'
    }
};
/*
...
module.exports = __webpack_require__(/*! C:\Users\aplaza\Desktop\9 - firechat\src\main.ts */"./src/main.ts");
